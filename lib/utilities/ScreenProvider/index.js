...
var ScreenProvider = /*#__PURE__*/function (_React$Component) {
  ...
  function ScreenProvider() {
    ...
    _this.componentDidMount = function () {
      if (_this.props.screenElement) {
        _this.resizeObserver = new _resizeObserverPolyfill.default(function (entries) {
          ...
          _this.setState(_objectSpread(_objectSpread({}, e.contentRect), {}, {
            isSet: true
          }));
        });
    ...
    _this.render = function () {
      return /*#__PURE__*/_react.default.createElement(_config.ScreenContext.Provider, {
        rect: _this.state
      }, /*#__PURE__*/_react.default.createElement(_config.ScreenContext.Consumer, null, _this.props.children));
    };

    return _this;
  }

  return _createClass(ScreenProvider);
